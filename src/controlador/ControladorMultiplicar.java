 ...
 * @author USER
 */
public class ControladorMultiplicar implements MouseListener{
    ...
    public ControladorMultiplicar(JTextField txtnum1, JTextField txtnum2, JTextField txtresultado) {
